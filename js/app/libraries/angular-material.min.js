...
! function(e, t, n) {
    ...
    function() {
        ...
        t.module("material.core").config(["$provide",
            function(t) {
                t.decorator("$mdUtil", ["$delegate",
                    function(t) {
                ...
                f = {
                        ...
                        function o(e, n) {
                            ...
                            if (r && r.length) {
                                ...
                                r.length && t.forEach(r, function(e) {
                                    e = t.element(e);
                                    var n = e[0].getAttribute(d),
                                        r = n && f.validateScope(e) ? e.scope().$eval(n) !== !1 : !0;
                                    r && (o = e)
                                })
                            }
                            return o
                    ...
                    disableScrollAround: function(e, n) {
                        function r(e) {
                            ...
                            e = t.element(e || d)[0];
                            var i = 50,
                                a = t.element('<div class="md-scroll-mask" style="z-index: ' + i + '">  <div class="md-scroll-mask-bar"></div></div>');
    ...
    function() {
        ...
        function o(n, o, r) {
            ...
            var c = navigator.userAgent || navigator.vendor || e.opera,
                s = c.match(/ipad|iphone|ipod/i),
                m = c.match(/android/i),
                u = "undefined" != typeof e.jQuery && t.element === e.jQuery,
                h = {
                    handler: a,
                    register: i,
        ...
        function a(e, n) {
            ...
            var m = "mousedown touchstart pointerdown",
                f = "mousemove touchmove pointermove",
            ...
            function o(e, o, r, i, a, d, c, s, l, m, u) {
                return function() {
                    function u(e) {
                        e = e || {};
                        var t = new g(e || {}),
                            n = !e.skipHide && M.length ? b.hide() : o.when(!0);
    ...
    function() {
        ! function() {
            function e(e) {
                function r(r, i) {
                    var c = !1,
                        s = ["", "-sm", "-gt-sm", "-md", "-gt-md", "-lg", "-gt-lg"];
                    return t.forEach(s, function(t) {
                        if (e === "layout" + t) {
                            var s = o(r, "md-layout" + t, i),
                                l = i.$normalize(e),
                                m = i[l] ? i[l].replace(/\s+/g, "-") : "row",
                                u = m ? !n(m) : !1,
                                h = n(m);
    ...
    function() {
        ...
        e.$inject = ["$mdButtonInkRipple", "$mdCheckboxInkRipple"], n.$inject = ["$injector"], o.$inject = ["$scope", "$element", "rippleOptions", "$window", "$timeout", "$mdUtil"], o.prototype.getColor = function(e) {
            ...
            if (this.isRippleAllowed()) {
                ...
                }, .35 * i, !1), this.options.dimBackground && this.container.css({
    ...
    function() {
        ...
        function i(e, n, o) {
            ...
            var r = [],
                ...
                m = /'?"?\{\{\s*([a-zA-Z]+)-(A?\d+|hue\-[0-3]|shadow)-?(\d\.?\d*)?(contrast)?\s*\}\}'?"?/g,
                u = l[i.name];
        ...
        function a(e) {
            ...
            if (r && 0 !== a.length) {
                ...
                M.forEach(function(e) {
                    ...
                    for (var t, n = (e.match(h), 0); t = M[n]; n++)
                        if (e.indexOf(".md-" + t) > -1) return d[t] += e;
                    for (n = 0; t = M[n]; n++)
                        if (e.indexOf(t) > -1) return d[t] += e;
                    return d[$] += e
        ...
        var l, m, u = {},
            ...
            f = "1px 1px 0px rgba(0,0,0,0.4), -1px -1px 0px rgba(0,0,0,0.4)",
            g = "",
            b = c("rgba(0,0,0,0.87)"),
            E = c("rgba(255,255,255,0.87"),
            v = c("rgb(255,255,255)"),
            M = ["primary", "accent", "warn", "background"],
            $ = "primary",
            y = {
                accent: {
                    "default": "A200",
        ...
        function e(e, n, o, r, i) {
            ...
            return a = {
                ...
                calculateZoomToOrigin: function(n, o) {
                    ...
                    if (r) {
                        var s = a.clientRect(r) || a.copyRect(o.bounds),
                            l = a.copyRect(n[0].getBoundingClientRect()),
                            m = a.centerPointFor(l),
                            u = a.centerPointFor(s);
                        c = d({
                            centerX: u.x - m.x,
                            centerY: u.y - m.y,
    ...
    function() {
        t.version.minor >= 4 ? t.module("material.core.animate", []) : ! function() {
            ...
            t.module("material.core.animate", []).factory("$$forceReflow", d).factory("$$AnimateRunner", s).factory("$$rAFMutex", c).factory("$animateCss", ["$window", "$$rAF", "$$AnimateRunner", "$$forceReflow", "$$jqLite", "$timeout",
                function(t, d, c, s, l, m) {
                    function u(o, d) {
                        var s = [],
                            l = M(o);
    ...
    function() {
        t.module("material.components.backdrop", ["material.core"]).directive("mdBackdrop", ["$mdTheming", "$animate", "$rootElement", "$window", "$log", "$$rAF", "$document",
    ...
    function() {
        ! function() {
            t.module("material.components.datepicker").config(["$provide",
                function(e) {
                    function t() {
        ...
        ! function() {
            ...
            o.$inject = ["$scope", "$element", "$attrs", "$compile", "$timeout", "$window", "$mdConstant", "$mdTheming", "$mdUtil", "$mdDateLocale", "$$mdDateUtil", "$$rAF"], o.prototype.configureNgModel = function(e) {
                ...
                var t = this.inputContainer.getBoundingClientRect(),
                    ...
                    a = i + this.$window.innerHeight,
                    s = document.body.scrollLeft,
                    l = document.body.scrollLeft + this.$window.innerWidth;
                if (r + c > l) {
                    if (l - c > 0) r = l - c;
                    else {
                        r = s;
    ...
    function() {
        ...
        function n(e) {
            ...
            function o(e, n, o, r, i, a, d, c) {
                ...
                function p(e, t) {
                    var r = "alert" === t.$type ? "alertdialog" : "dialog",
                        i = e.find("md-dialog-content"),
                        a = e.attr("id") || "dialog_" + o.nextUid();
                    e.attr({
                        role: r,
                        tabIndex: "-1"
                ...
                function g(e, t) {
                    var n = "fixed" == d.getComputedStyle(a[0].body).position,
                        r = t.backdrop ? d.getComputedStyle(t.backdrop[0]) : null,
                        i = r ? Math.min(a[0].body.clientHeight, Math.ceil(Math.abs(parseInt(r.height, 10)))) : 0;
                    return e.css({
                        top: (n ? o.scrollTop(t.parent) : 0) + "px",
                        height: i ? i + "px" : "100%"
                    }), e
                }
                ...
                function b(e, t) {
                    ...
                    var n = e.find("md-dialog"),
                        ...
                        d = r.toTransformCss(i(n, t.origin)),
                        c = r.toTransformCss("");
    ...
    function() {
        function e(e, o, r, i) {
            function a(n, a, d, c) {
                ...
                var A = t.bind(c, c.invalidateLayout),
                    C = s();
                n.$on("$destroy", l);
                var T, k = e.startSymbol(),
                    w = e.endSymbol(),
                    x = e(h("share") + "% - (" + h("gutter") + " * " + h("gutterShare") + ")"),
                    N = e("calc((" + h("unit") + " + " + h("gutter") + ") * " + h("offset") + ")"),
                    _ = e("calc((" + h("unit") + ") * " + h("span") + " + (" + h("span") + " - 1) * " + h("gutter") + ")")
            }
            return {
                restrict: "E",
                controller: n,
    ...
    function() {
        ...
        function r(e) {
            function n(n, o, r, i) {
                ...
                var d, c = i[0],
                    s = i[1],
                    l = t.element('<div class="md-char-counter">'),
                    m = t.element(s.element[0].querySelector("[md-maxlength]"));
                r.$set("ngTrim", "false");
                var u = ["ng-messages", "data-ng-messages", "x-ng-messages", "[ng-messages]", "[data-ng-messages]", "[x-ng-messages]"],
                    h = s.element[0].querySelector(u.join(","));
        ...
        function n(e, n, o, r) {
            ...
            return {
                ...
                compile: function(a, d) {
                    ...
                    function s(n) {
                        var o;
                        if ("div" == n) o = t.element('<div class="md-no-style md-list-item-inner">'), o.append(a.contents()), a.addClass("md-proxy-focus");
                        else {
                    ...
                    function m(e, a, d, c) {
                        ...
                        var m = [],
                            u = a[0].firstElementChild,
                            h = u && u.hasAttribute("ng-click");
                    ...
                    if (a[0].setAttribute("role", "listitem"), d.ngClick) s("button");
                    else {
                        for (var f, g = 0; f = i[g]; ++g)
                            if (h = a[0].querySelector(f)) {
                                u = !0;
                                break
                            }
    ...
    function() {
        function e(e, o, r) {
            ...
            function a(i, a, h) {
                ...
                function f() {
                    $.css(A({
                        transform: o.supplant("scale( {0} )", [E()])
                    }))
                }

                function g() {
                    if (t.isUndefined(h.mdMode)) {
                        var e = t.isDefined(h.value),
                            n = e ? m : u,
                ...
                function E() {
                    ...
                    var e = /([0-9]*)%/.exec(h.mdDiameter),
                        t = Math.max(0, e && e[1] / 100 || parseFloat(h.mdDiameter));
                    return t > 1 ? t / s : t
                }
    ...
    function() {
        function e(e, o, r, i, a, d) {
            function c(c, s) {
                ...
                var h = t.isDefined(s.multiple) ? "multiple" : "",
                    p = '<div class="md-select-menu-container"><md-select-menu {0}>{1}</md-select-menu></div>';
                return p = o.supplant(p, [h, c.html()]), c.empty().append(l), s.tabindex = s.tabindex || "0",
                    function(c, s, l, m) {
                        function u() {
                        ...
                        function b(e) {
                            var n = [32, 13, 38, 40];
                            if (-1 != n.indexOf(e.keyCode)) e.preventDefault(), E(e);
                        ...
                        var v, M = m[0],
                            ...
                            y = m[2],
                            A = m[3],
                            C = s.find("md-select-value"),
                            T = t.isDefined(l.readonly);
                        if (M) {
                        ...
                        var w, x, N;
                        if (g(), r(s), l.name && A) {
                            var _ = s.parent()[0].querySelector('select[name=".' + l.name + '"]'),
                                H = t.element(_).controller();
                            H && A.$removeControl(H)
                        }
            ...
            function i(e, n, i, a) {
                ...
                function s(n) {
                    ...
                    if (r && i) {
                        ...
                        var a = l.hashGetter(i.value),
                            d = t.isDefined(l.selected[a]);
                        e.$apply(function() {
            ...
            function a(r, i, a) {
                ...
                l.optNodeForKeyboardSearch = function(e) {
                    ...
                    for (var r = 0; r < p.length; ++r)
                        if (o.test(p[r])) return h[r]
                }, l.init = function(n) {
                    if (l.ngModel = n, n.$options && n.$options.trackBy) {
                        var o = {},
                            i = e(n.$options.trackBy);
        ...
        function a(e) {
            function o(e, o, c, s, l, m, u, h) {
                ...
                function f(r, i, a) {
                    ...
                    function f(e, t, n) {
                        return n.disableParentScroll && !c.getClosest(n.target, "MD-DIALOG") ? n.restoreScroll = c.disableScrollAround(n.element, n.parent) : n.disableParentScroll = !1, n.hasBackdrop && (n.backdrop = c.createBackdrop(e, "md-select-backdrop md-click-catcher"), h.enter(n.backdrop, n.parent, null, {
                                duration: 0
                            })),
                            function() {
                    ...
                    function C() {
                        ...
                        function d(e) {
                            var t, o = c.nodesToArray(a.optionNodes),
                                r = o.indexOf(a.focusedNode);
                            do -
                            1 === r ? r = 0 : "next" === e && r < o.length - 1 ? r++ : "prev" === e && r > 0 && r--, t = o[r], t.hasAttribute("disabled") && (t = n);
                            while (!t && r < o.length - 1 && r > 0);
                        ...
                        if (!a.isRemoved) {
                            var u = a.selectEl,
                                h = u.controller("mdSelectMenu") || {};
                            return i.addClass("md-clickable"), a.backdrop && a.backdrop.on("click", t), u.on("keydown", r), u.on("mouseup", m),
                                function() {
                ...
                function v(e, n, o) {
                    var l, m, u = n[0],
                        h = o.target[0].firstElementChild,
                        p = o.parent[0],
                        f = o.selectEl[0],
                        g = o.contentEl[0],
                        ...
                        y = b.width - 2 * d,
                        A = g.scrollHeight > g.offsetHeight,
                        C = f.querySelector("md-option[selected]"),
                        l = f.getElementsByTagName("md-option"),
                        T = f.getElementsByTagName("md-optgroup"),
                        k = r(o.loadingAsync);
                    ...
                    var R = u.getBoundingClientRect(),
                        L = Math.round(100 * Math.min(E.width / x.width, 1)) / 100,
                        P = Math.round(100 * Math.min(E.height / x.height, 1)) / 100;
                    return {
                        container: {
                            element: t.element(u),
                            styles: {
    ...
    function() {
        function e(e, n, o, r, i, a, d, c, s) {
            ...
            function m(o, l, m, u) {
                ...
                var F = t.element(l[0].querySelector(".md-thumb")),
                    B = t.element(l[0].querySelector(".md-thumb-text")),
                    U = F.parent(),
                    q = t.element(l[0].querySelector(".md-track-container")),
                    z = t.element(l[0].querySelector(".md-track-fill")),
                    j = t.element(l[0].querySelector(".md-track-ticks")),
                    V = r.throttle(v, 5e3);
        ...
        function e(e, o, r, i) {
            function a(e) {
                ...
                function a() {
                    ...
                    for (var e, t = h.prop("scrollTop"), n = f.items.length - 1; n >= 0; n--)
                        if (t > f.items[n].top) {
                            e = f.items[n];
                            break
                        }
    ...
    function() {
        function e(e, n, o, r, i, a, d, c, s) {
            function l(l, h, p) {
                ...
                function k() {
                    function e() {
                        var e = "left" === _ || "right" === _ ? 2 * Math.sqrt(Math.pow(o.width, 2) + Math.pow(o.height / 2, 2)) : 2 * Math.sqrt(Math.pow(o.width / 2, 2) + Math.pow(o.height, 2)),
                            t = "left" === _ ? {
                                left: 100,
                                top: 50
                            } : "right" === _ ? {
                    ...
                    function n(e) {
                        return "left" === e ? {
                            ...
                            left: r.left + r.width / 2 - o.width / 2,
                            top: r.top + r.height + u
                        }
                    }
                    var o = i.offsetRect(h, S),
                        r = i.offsetRect(w, S),
                        a = n(_);
                ...
                a(h);
                var w = v(),
                    x = t.element(h[0].getElementsByClassName("md-background")[0]),
                    N = t.element(h[0].getElementsByClassName("md-content")[0]),
                    _ = p.mdDirection,
                    H = M(),
                    S = t.element(H || document.body),
                    D = o.throttle(function() {
                        l.visible && k()
                    });
                f(), E(), y(), g(), b()
            }
    ...
    function() {
        ...
        o.$inject = ["$$rAF", "$scope", "$element", "$attrs"], o.prototype.register = function(e) {
            ...
            if (d > e) this.sizer.style[t] = e + "px";
            else {
    ...
    function() {
        function e(e, o, a, d, c, s, l, m, u, h) {
            ...
            function f() {
                function t() {
                    var e = re.scrollContainer.getBoundingClientRect(),
                        t = {};
                    e.right > d.right - i && (t.left = n.right - e.width + "px"), re.$.scrollContainer.css(t)
                }
                if (!re) return a.nextTick(f, !1, e);
                var n = re.wrap.getBoundingClientRect(),
                    o = re.snap.getBoundingClientRect(),
                    d = re.root.getBoundingClientRect(),
                    c = o.bottom - d.top,
                    s = d.bottom - o.top,
                    l = n.left - d.left,
                    m = n.width,
            ...
            function S(e) {
                var t = de.indexOf(e); - 1 != t && de.splice(t, 1)
            }
            ...
            function W() {
                ...
                t.initCustomEvent("input", !0, !0, {
                    value: e.searchText
                }), re.input.dispatchEvent(t), re.input.focus()
            }
            ...
            function X() {
                if (re.li[0]) {
                    var e = re.li[0].offsetHeight,
                        t = e * te.index,
                        n = t + e,
                        o = re.scroller.clientHeight,
                        r = re.scroller.scrollTop;
                    r > t ? Q(t) : n > r + o && Q(n - o)
                }
            }
    ...
    function() {
        ...
        var n = '      <md-chips-wrap          ng-if="!$mdChipsCtrl.readonly || $mdChipsCtrl.items.length > 0"          ng-keydown="$mdChipsCtrl.chipKeydown($event)"          ng-class="{ \'md-focused\': $mdChipsCtrl.hasFocus(), \'md-readonly\': !$mdChipsCtrl.ngModelCtrl }"          class="md-chips">        <md-chip ng-repeat="$chip in $mdChipsCtrl.items"            index="{{$index}}"            ng-class="{\'md-focused\': $mdChipsCtrl.selectedChip == $index, \'md-readonly\': $mdChipsCtrl.readonly}">          <div class="md-chip-content"              tabindex="-1"              aria-hidden="true"              ng-focus="!$mdChipsCtrl.readonly && $mdChipsCtrl.selectChip($index)"              md-chip-transclude="$mdChipsCtrl.chipContentsTemplate"></div>          <div ng-if="!$mdChipsCtrl.readonly"               class="md-chip-remove-container"               md-chip-transclude="$mdChipsCtrl.chipRemoveTemplate"></div>        </md-chip>        <div ng-if="!$mdChipsCtrl.readonly && $mdChipsCtrl.ngModelCtrl"            class="md-chip-input-container"            md-chip-transclude="$mdChipsCtrl.chipInputTemplate"></div>        </div>      </md-chips-wrap>',
            o = '        <input            tabindex="0"            placeholder="{{$mdChipsCtrl.getPlaceholder()}}"            aria-label="{{$mdChipsCtrl.getPlaceholder()}}"            ng-model="$mdChipsCtrl.chipBuffer"            ng-focus="$mdChipsCtrl.onInputFocus()"            ng-blur="$mdChipsCtrl.onInputBlur()"            ng-keydown="$mdChipsCtrl.inputKeydown($event)">',
            r = "      <span>{{$chip}}</span>",
        ...
        function e(e) {
            ...
            function r(e, o, r, i) {
                var a = i[0],
                    ...
                    s = o.children()[1];
                c.append(s), d && (o.append(c), c[0].style.display = "none"), a.init(c, {
                    isInMenuBar: d
                }), e.$on("$destroy", function() {
        ...
        function e(e) {
            function o(e, o, a, d, c, s, l, m, u) {
                ...
                function v(t, o) {
                    ...
                    var k = Math.round(100 * Math.min(b.width / l.offsetWidth, 1)) / 100,
                        w = Math.round(100 * Math.min(b.height / l.offsetHeight, 1)) / 100;
                    return {
    ...
    function() {
        ...
        e.$inject = ["$scope", "$element", "$attrs", "$mdConstant", "$document", "$mdUtil", "$timeout"], e.prototype.init = function() {
            ...
            var e = this.$mdUtil,
                t = (this.$element, e.getClosest(this.$document[0].activeElement, "MD-MENU"));
            if (!t) return -1;
    ...
    function() {
        function e() {
            function e(e, n, o, r) {
                if (r) {
                    var i = r.getTabElementIndex(n),
                        a = n.find("md-tab-body").eq(0).remove(),
                        d = n.find("md-tab-label").eq(0).remove(),
                        c = r.insertTab({
                            scope: e,
                            parent: e.$parent,
                            index: i,
            ...
            return {
                ...
                terminal: !0,
                compile: function(n, o) {
                    var r = n.find("md-tab-label"),
                        i = n.find("md-tab-body");
    ...
    function() {
        function e(e, n, o, r, i, a, d, c, s, l) {
            ...
            function H() {
                var e, t, n = ce.canvas.clientWidth,
                    o = n + ae.offsetLeft;
            ...
            function R(e) {
                if (!le) {
                    var t = ae.selectedIndex,
                        n = ae.tabs.splice(e.getIndex(), 1)[0];
            ...
            function K() {
                var e = ae.tabs[ae.selectedIndex],
                    t = ae.tabs[ae.focusIndex];
            ...
            function te() {
                ...
                var e = ce.contents[ae.selectedIndex],
                    t = e ? e.offsetHeight : 0,
                    o = ce.wrapper.offsetHeight,
                    r = t + o,
                    i = n.prop("clientHeight");
                if (i !== r) {
                    de = !0;
                    var c = {
                            height: i + "px"
            ...
            function ie(e, n) {
                var o = {
                    colorElement: t.element(ce.inkBar)
                };
                i.attach(e, n, o)
            }
            var ae = this,
